...
void FileRemove()
{
  /* if (Day == 1 && Hour == 0 && Min == 0 && Sec == 1 && !FirstLog && !SecondLog)         // check if it is then of the month
    {
     myFile = SD.open("LOG.txt", FILE_WRITE);
     myFile.close();
     FirstLog = true;
    }
    if (Day == 1 && Hour == 0 && Min == 0 && Sec == 1  && FirstLog && !SecondLog)
    {
     myFile = SD.open("LOG.txt", FILE_WRITE);
    ...
    else if (Day == 1 && Hour == 0 && Min == 0 && Sec == 1 && FirstLog && SecondLog)         // check if it is then of the month
    {
...
void ShowTime()
{
  ...
  {
    myGLCD.print(":", 37, 220);
    myGLCD.print("/", 182, 220);
    myGLCD.print("/", 230, 220);
    myGLCD.print("20", 246, 220);
    if (Hour < 10)
    {
      myGLCD.printNumI(0, 5, 220);
      myGLCD.printNumI(Hour, 21, 220);
    }
    else
      myGLCD.printNumI(Hour, 5, 220);

    if (Min < 10)
    {
      myGLCD.printNumI(0, 53, 220);
      myGLCD.printNumI(Min, 69, 220);
    }
    else
      myGLCD.printNumI(Min, 53, 220);
    if (Day < 10)
    {
      myGLCD.printNumI(0, 150, 220);
      myGLCD.printNumI(Day, 166, 220);
    }
    else
      myGLCD.printNumI(Day, 150, 220);
    if (Month < 10)
    {
      myGLCD.printNumI(0, 198, 220);
      myGLCD.printNumI(Month, 214, 220);
    }
    else
      myGLCD.printNumI(Month, 198, 220);
    if (Year < 10)
    {
      myGLCD.printNumI(0, 278, 220);
      myGLCD.printNumI(Year, 294, 220);
    }
    else
      myGLCD.printNumI(Year, 278, 220);
  }
  ////////////////////////////////////////////////////////////PORTRAIT TIME////////////////////////////
  else
  {
    ...
    myGLCD.print("/", 37, 300);
    myGLCD.print("/", 85, 300);
    myGLCD.print("20", 101, 300);
    if (Hour < 10)
    {
      myGLCD.printNumI(0, 5, 280);
      myGLCD.printNumI(Hour, 21, 280);
    }
    else
      myGLCD.printNumI(Hour, 5, 280);
    if (Min < 10)
    {
      myGLCD.printNumI(0, 53, 280);
      myGLCD.printNumI(Min, 69, 280);
    }
    else
      myGLCD.printNumI(Min, 53, 280);

    if (Day < 10)
    {
      myGLCD.printNumI(0, 5, 300);
      myGLCD.printNumI(Day, 21, 300);
    }
    else
      myGLCD.printNumI(Day, 5, 300);
    if (Month < 10)
    {
      myGLCD.printNumI(0, 53, 300);
      myGLCD.printNumI(Month, 69, 300);
    }
    else
      myGLCD.printNumI(Month, 53, 300);
    if (Year < 10)
    {
      myGLCD.printNumI(0, 133, 300);
      myGLCD.printNumI(Year, 149, 300);
    }
    else
      myGLCD.printNumI(Year, 133, 300);
  }
}
        ...
        if ((x >= 0) && (x <= 319))
        {
          if ((y >= 120) && (y <= 239))       //suspend is selected
          {
            ...
            while (timer > 0)
            {
              ...
              timer = timer - 1;
              myGLCD.printNumI(timer, CENTER, 160);
              delay(1000);
            }
            drawLayer();
            return;
